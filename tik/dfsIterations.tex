    \documentclass{beamer}
        ...
        \begin{frame}
        \frametitle{Depth-First Traversal : Input}
        \begin{center}
        ...
        \end{frame}
            ...
            \begin{frame}
            \frametitle{Depth-First Traversal Iteration:1 Stack:[3]}
        ...
        \end{tikzpicture}
            ...
            \begin{frame}
            \frametitle{Depth-First Traversal Iteration:2 Stack:[3,6]}
        ...
        \end{tikzpicture}
            ...
            \begin{frame}
            \frametitle{Depth-First Traversal Iteration:3 Stack:[3,6,0]}
        ...
        \end{tikzpicture}
            ...
            \begin{frame}
            \frametitle{Depth-First Traversal Iteration:4 Stack:[3,6,0,4]}
        ...
        \end{tikzpicture}
            ...
            \begin{frame}
            \frametitle{Depth-First Traversal Iteration:5 Stack:[3,6,0,5]}
        ...
        \end{tikzpicture}
            ...
            \begin{frame}
            \frametitle{Depth-First Traversal Iteration:6 Stack:[3,6,0,7]}
        ...
        \end{tikzpicture}
            ...
            \begin{frame}
            \frametitle{Depth-First Traversal Iteration:7 Stack:[3,6,0,7,1]}
        ...
        \end{tikzpicture}
            ...
            \begin{frame}
            \frametitle{Depth-First Traversal Iteration:8 Stack:[3,6,0,7,1,2]}
