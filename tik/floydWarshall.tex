...
\node[v] at (\x,\y) {#3};
    ...
    \begin{document}
        ...
        \tikzset{quadratic bezier/.style={ to path={(\tikztostart) .. controls($#1!1/3!(\tikztostart)$) and ($#1!1/3!(\tikztotarget)$).. (\tikztotarget)}}}
            ...
            \node [node_style](n1) at (4.424,-10.602) {1};
            \node [node_style](n2) at (4.424,-5.443) {2};
            \node [node_style](n3) at (6.514,-2.506) {3};
            \node [node_style](n4) at (8.446,-5.443) {4};
            \node [node_style](n5) at (8.446,-10.602) {5};\draw [edge_style] (n1) .. controls (2.331,-9.381) and (2.183,-6.798) .. node [edge_node_style] {$3.0$} (n2);
                    \draw [edge_style] (n2) to[edge label=-2.0] (n1);
            \draw [edge_style] (n2) to[bend left,edge label=4.0] (n3);
            \draw [edge_style] (n3) to[edge label=4.0] (n2);
