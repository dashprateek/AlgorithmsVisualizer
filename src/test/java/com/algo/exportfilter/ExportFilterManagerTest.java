...
package com.algo.exportfilter;

import com.algo.export.ExportFilterManager;
import com.algo.export.LEDAExport;
import com.algo.export.TikZExport;
import com.algo.export.TrivialGraphFormatExport;
...
public class ExportFilterManagerTest {
    ...
    public void testInstantiateExportFilterByExtension() throws Exception {
        ...
        assertThat(ExportFilterManager.instantiateExportFilterByExtension(Structure.class, "tgf"),
                org.hamcrest.Matchers.instanceOf(TrivialGraphFormatExport.class));
    ...
    public void testTikZExport() throws Exception {
        ...
        ExportFilterManager.instantiateExportFilterByExtension(DirectedGraph.class, "tex")
                .exportGraph(getTestStructure(), out, null);
        out.flush();
